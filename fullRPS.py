...
buildTMatrixrpsclsp = {'rr': 1, 'rp': 1, 'rsc': 1, 'rl': 1, 'rsp': 1, 'pr': 1, 'pp': 1, 'psc': 1, 'pl': 1, 'psp': 1,
                       'scr': 1, 'scp': 1, 'scsc': 1, 'scl': 1, 'scsp': 1, 'lr': 1, 'lp': 1, 'lsc': 1, 'll': 1,
                       'lsp': 1, 'spr': 1, 'spp': 1, 'spsc': 1, 'spl': 1, 'spsp': 1}
buildTMatrixLrpsclsp = {'rr': 1, 'rp': 1, 'rsc': 1, 'rl': 1, 'rsp': 1, 'pr': 1, 'pp': 1, 'psc': 1, 'pl': 1, 'psp': 1,
                        'scr': 1, 'scp': 1, 'scsc': 1, 'scl': 1, 'scsp': 1, 'lr': 1, 'lp': 1, 'lsc': 1, 'll': 1,
                        'lsp': 1, 'spr': 1, 'spp': 1, 'spsc': 1, 'spl': 1, 'spsp': 1}
buildTMatrixTrpsclsp = {'rr': 1, 'rp': 1, 'rsc': 1, 'rl': 1, 'rsp': 1, 'pr': 1, 'pp': 1, 'psc': 1, 'pl': 1, 'psp': 1,
                        'scr': 1, 'scp': 1, 'scsc': 1, 'scl': 1, 'scsp': 1, 'lr': 1, 'lp': 1, 'lsc': 1, 'll': 1,
                        'lsp': 1, 'spr': 1, 'spp': 1, 'spsc': 1, 'spl': 1, 'spsp': 1}
...
def chooseMode():
    ...
    try:
        mode = int(input(
            "What Mode do you want to play in? 1: beginner, 2: intermediate, 3: expert, or 4: super hard? Enter a number \n"))
    except ValueError:
    ...
    if (mode > 4 and mode != 73):
        ...
        while (mode > 4 and mode != 73):
            try:
                mode = int(input(
                    "What Mode do you want to play in? 1: begginner, 2: intermediate, 3: expert, or 4: super hard? Enter a number \n"))
            except ValueError:
                print("you must enter an integer \n")
    return mode
    ...
    while (continuePlaying):
        ...
        if ((choice > 2 or choice < 0) and choice != 5):
            ...
            while ((choice > 2 or choice < 0) and choice != 5):
                try:
                    print(
                        "You must enter an integer less than three and greater than or equal to 0 or choose 5 to exit. \n")
                    choice = int(input("0: Rock, 1: Paper, 2: Scissors, 5: exit \n"))
                except ValueError:
                    print("you must enter an integer \n")
...
def buildTransitionMatrixrpsclsp(winlosstwo):
    ...
    if winlosstwo == "Win!":
        rock = buildTMatrixrpsclsp['rr'] + buildTMatrixrpsclsp['rsc'] + buildTMatrixrpsclsp['rp'] + buildTMatrixrpsclsp[
            'rl'] + buildTMatrixrpsclsp['rsp']
        paper = buildTMatrixrpsclsp['pr'] + buildTMatrixrpsclsp['psc'] + buildTMatrixrpsclsp['pp'] + \
                buildTMatrixrpsclsp['pl'] + buildTMatrixrpsclsp['psp']
        scissors = buildTMatrixrpsclsp['scr'] + buildTMatrixrpsclsp['scsc'] + buildTMatrixrpsclsp['scp'] + \
                   buildTMatrixrpsclsp['scl'] + buildTMatrixrpsclsp['scsp']
        lizard = buildTMatrixrpsclsp['lr'] + buildTMatrixrpsclsp['lsc'] + buildTMatrixrpsclsp['lp'] + \
                 buildTMatrixrpsclsp['ll'] + buildTMatrixrpsclsp['lsp']
        spock = buildTMatrixrpsclsp['spr'] + buildTMatrixrpsclsp['spsc'] + buildTMatrixrpsclsp['spp'] + \
                buildTMatrixrpsclsp['spl'] + buildTMatrixrpsclsp['spsp']
        choi = ['r', 'p', 'sc', 'l', 'sp']
        ...
        rock = buildTMatrixTrpsclsp['rr'] + buildTMatrixTrpsclsp['rsc'] + buildTMatrixTrpsclsp['rp'] + \
               buildTMatrixTrpsclsp['rl'] + buildTMatrixTrpsclsp['rsp']
        paper = buildTMatrixTrpsclsp['pr'] + buildTMatrixTrpsclsp['psc'] + buildTMatrixTrpsclsp['pp'] + \
                buildTMatrixTrpsclsp['pl'] + buildTMatrixTrpsclsp['psp']
        scissors = buildTMatrixTrpsclsp['scr'] + buildTMatrixTrpsclsp['scsc'] + buildTMatrixTrpsclsp['scp'] + \
                   buildTMatrixTrpsclsp['scl'] + buildTMatrixTrpsclsp['scsp']
        lizard = buildTMatrixTrpsclsp['lr'] + buildTMatrixTrpsclsp['lsc'] + buildTMatrixTrpsclsp['lp'] + \
                 buildTMatrixTrpsclsp['ll'] + buildTMatrixTrpsclsp['lsp']
        spock = buildTMatrixTrpsclsp['spr'] + buildTMatrixTrpsclsp['spsc'] + buildTMatrixTrpsclsp['spp'] + \
                buildTMatrixTrpsclsp['spl'] + buildTMatrixTrpsclsp['spsp']
        choi = ['r', 'p', 'sc', 'l', 'sp']
        ...
        rock = buildTMatrixLrpsclsp['rr'] + buildTMatrixLrpsclsp['rsc'] + buildTMatrixLrpsclsp['rp'] + \
               buildTMatrixLrpsclsp['rl'] + buildTMatrixLrpsclsp['rsp']
        paper = buildTMatrixLrpsclsp['pr'] + buildTMatrixLrpsclsp['psc'] + buildTMatrixLrpsclsp['pp'] + \
                buildTMatrixLrpsclsp['pl'] + buildTMatrixLrpsclsp['psp']
        scissors = buildTMatrixLrpsclsp['scr'] + buildTMatrixLrpsclsp['scsc'] + buildTMatrixLrpsclsp['scp'] + \
                   buildTMatrixLrpsclsp['scl'] + buildTMatrixLrpsclsp['scsp']
        lizard = buildTMatrixLrpsclsp['lr'] + buildTMatrixLrpsclsp['lsc'] + buildTMatrixLrpsclsp['lp'] + \
                 buildTMatrixLrpsclsp['ll'] + buildTMatrixLrpsclsp['lsp']
        spock = buildTMatrixLrpsclsp['spr'] + buildTMatrixLrpsclsp['spsc'] + buildTMatrixLrpsclsp['spp'] + \
                buildTMatrixLrpsclsp['spl'] + buildTMatrixLrpsclsp['spsp']
        choi = ['r', 'p', 'sc', 'l', 'sp']
